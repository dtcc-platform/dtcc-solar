...
def test_sunpaths():
    ...
    calc_sunpath_deviation(locations["London"], plot)

    calc_sunpath_deviation(locations["Gothenburg"], plot)

    calc_sunpath_deviation(locations["Stockholm"], plot)

    calc_sunpath_deviation(locations["Oslo"], plot)

    calc_sunpath_deviation(locations["Helsinki"], plot)
    
    calc_sunpath_deviation(locations["Kiruna"], plot)

    calc_sunpath_deviation(locations["NYC"], plot)
...
def calc_sunpath_deviation(location, plot:bool):
    ...
    #print("------------------------- Sunpath Testing Started for " + str(name) +  "-------------------------")
