...
class Shading:
    ...
    def ExecuteShadingV(self, sun_vec):
        ...
        for i in range(0, iterCount):
            ...
            [faceShading, vertexInSun, face_in_sun] = raycasting.raytrace_v(
            ...
            evalMesh = (
                mesh_border_SD  # Set the subDee mesh to be evaluated next iteration!
            )
        ...
        [faceShadingSD, vertexInSun, face_in_sun] = raycasting.raytrace_v(
